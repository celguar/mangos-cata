ALTER TABLE spell_template ADD `MaxLevel` INT UNSIGNED NOT NULL DEFAULT '0' AFTER ProcFlags;
ALTER TABLE spell_template ADD `BaseLevel` INT UNSIGNED NOT NULL DEFAULT '0' AFTER MaxLevel;
ALTER TABLE spell_template ADD `SpellLevel` INT UNSIGNED NOT NULL DEFAULT '0' AFTER BaseLevel;
